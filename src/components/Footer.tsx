...
export const Footer = memo(() => {
  ...
  return (
    <footer className="bg-gray-900 text-white mt-auto overflow-x-hidden w-full max-w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              <li><Link to="/donate" className="hover:text-white transition-colors">{t('footer.features')}</Link></li>
